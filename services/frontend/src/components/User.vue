...
<div>
  <b-navbar-nav class="ml-auto">
    ...
    <b-nav-item @click="editOn" v-if="!isEditOn && isLoggedIn" title="Enter edit mode">
      <v-icon name="lock" />
    </b-nav-item>
  </b-navbar-nav>
  ...
  <b-modal ref="login_modal" id="login_modal" title="Kumori Login">
    <b-form-group id="login_username_group" label="Username:" label-for="login_username">
      <b-form-input id="login_username" type="text" v-model="username" required placeholder="Username">
      </b-form-input>
    </b-form-group>
    <b-form-group id="login_passoword_group" label="Password:" label-for="login_password">
      <b-form-input id="login_password" type="password" v-model="password" v-on:keydown.native.enter="login" required placeholder="Password">
      </b-form-input>
    </b-form-group>
