<template>
<div :id="'edit_'+uid">
  <b-alert v-if="!isEditOn" show variant="danger">
    <v-icon name="times" scale="2"/>
    You must be logged in, and enable editing, before you can proceed.
    <p>{{techModel}}</p>
  </b-alert>
  <b-card :id="'editor_'+uid" v-else no-body>
    <b-card-header :id="'editor_header_'+uid">
      Edit Technology:
    ...
    <b-card-body :id="'editor_body_'+uid">
      <b-form :id="'editor_form_'+uid" @submit.prevent="onSubmit" @reset.prevent="onReset">
        <b-list-group flush>
          <b-list-group-item>
            <h4>Basic Information</h4>
            <b-form-group :id="'uidGroup_'+uid" label="ID of technology" label-for="uidInput" description="Tech ID is autogenerated">
              <b-form-input :id="'uidInput_'+uid" ref="uidInput" type="text" readonly v-model="techModel.uid" placeholder="tech uid is autogenerated">
              </b-form-input>
            </b-form-group>
            <b-form-row>
              <b-form-group id="nameInputGroup" label="Name of technology" label-for="nameInput" description="What is the name of the technology?">
            ...
            <b-form-group id="nameInputGroup" label="Description of technology" label-for="nameInput" description="What is the name of the technology?">
              <b-form-textarea id="descText" v-model="techModel.description" placeholder="Descibe what this tech is about..." :rows="3" :max-rows="6">
              </b-form-textarea>
            </b-form-group>
          </b-list-group-item>
        </b-list-group>
      ...
      <b-form>
        <b-list-group>
          ...
          <b-list-group-item v-if="techModel.log" v-for="entry in techModel.log" :key="entry">
            <v-icon name="play" />
