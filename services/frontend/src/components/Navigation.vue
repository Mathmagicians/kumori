...
<b-navbar toggleable="md" type="dark" variant="dark">
  ...
  <b-navbar-brand to="/">
    <b-img :src="require('../assets/kumori_white.svg')" width="32" height="32" />
  ...
  <b-collapse is-nav id="nav_collapse">
    <b-navbar-nav>
      ...
      <b-nav-item v-if="authenticated" to="/projects">
    ...
    <b-navbar-nav class="ml-auto">
      <b-nav-form>
        <b-input-group>
          <b-form-input size="sm" type="text" placeholder="Search..." v-on:keydown.native="onEnter"></b-form-input>
