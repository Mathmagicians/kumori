  ...
  <b-form v-else>
    <b-list-group>
      ...
      <b-list-group-item>
        ...
        >
          <b-form-group
            :id="'usecaseNameInputGroup_' + index"
          ...
          <b-form-group
            :id="'usecaseDescInputGroup_' + index"
          ...
          <b-form-group
            ...
            description="What is the current status of the tech for this usecase on Kumori?"
          >
            <b-form-row>
              <b-form-select
                :id="'usecaselc_' + index"
              ...
              />
              <life-cycle
                :status="techModel.usecases[index].status"
              ></life-cycle>
            </b-form-row>
          </b-form-group>
        </b-list-group-item>
