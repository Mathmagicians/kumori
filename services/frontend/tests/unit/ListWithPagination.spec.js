...
describe("ListWithPagination.vue", () => {
  ...
  describe("Buttons state and logic", () => {
    ...
    it(
      "The amount of visible page buttons is same as buttonPanelSize if number of pages > bps"
    );
    it(
      "The amount of visible page buttons is same as number of pages if buttonPanelSize > #pagese"
    );
  ...
  describe("Slots and list logic", () => {
    ...
    it(
      "Number of visible components in the list is the same as property size for regular page"
    );
    it(
      "Length of list is shorter for last page, if page length does not divide total"
    );
  });
});
