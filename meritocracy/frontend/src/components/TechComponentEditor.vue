				...
				<b-form @submit="onSubmit" @reset="onReset">
					 <b-list-group flush>
						...
						<b-list-group-item 
							...
							{{entry.date}}: {{entry.description}} <life-cycle :status="entry.status"></life-cycle>
						</b-list-group-item>
					</b-list-group>
...
export default {
	...
	methods: {
		...
		createLogEntry(){
			this.techModel.log.unshift( {...this.useCaseModel, date: new Date()})
			console.log("tried to add log entry")
		}
	}
};
</script>
